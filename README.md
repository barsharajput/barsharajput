...
- 🎓 B.Tech CSE Student
- 💻 Skilled in Java, Python, Full Stack Development & Machine Learning
- 🚀 Passionate about building real-world scalable applications
- 📊 Interested in NLP, Backend Systems & Problem Solving
...
- 🌐 Live: https://pgbuddy-gycu.onrender.com/

- 💻 Code: https://github.com/barsharajput/smart_pg_finder

- ⚙️ Tech: Flask, Python, HTML, CSS, JavaScript, SQLite

- 🔍 Features:
  
  - 🔎 Smart search & filtering based on budget and preferences
  - 🧾 User authentication (Login/Signup system)
  - 🏠 PG listing & detailed view pages
